...
//[]-------------------------------------------------------------[]
//   Função: tem_elementos_repetidos()
//   Entrada: vetor de inteiros v[] e o seu tamanho n
//   Saída:   devolve true se existem elementos repetidos
//            devolve falso caso contrario
//[]-------------------------------------------------------------[]
bool tem_elementos_repetidos(int v[], int n){
   for(int i = 0; i < n; i++){
      for(int j = i + 1; j < n; j++)
         if (v[i] == v[j])
	      return true;	 
...
void caso_de_teste01(){
   int v[6] = {1,2,3,4,5,6};
   testar(tem_elementos_repetidos(v, 6), false);
}

void caso_de_teste02(){
   int v[10] = {2,7,6,4,5,9,8,7,10,2};
   testar(tem_elementos_repetidos(v, 10), true);
}
...
void caso_de_teste04(){
   ...
   testar(tem_elementos_repetidos(v, 7), true);
}
...
void caso_de_teste06(){
   ...
   testar(tem_elementos_repetidos(v, 10), false);
}
